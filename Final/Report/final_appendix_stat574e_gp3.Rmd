...
az_wf_splm_esv <- esv(IncidentSize ~ distance_rd_min_prisec + tmax + tmin + prcp + mean_slope + mean_forest + pop.density + pop., data = az_fires_wf_lm)

plot(az_wf_splm_esv)

az_wf_splm <- splm(IncidentSize ~ distance_rd_min_prisec + tmax + tmin + prcp + mean_slope + mean_forest + pop.density + pop., data = az_fires_wf_lm, spcov_type = "matern", estmethod = "sv-wls")
