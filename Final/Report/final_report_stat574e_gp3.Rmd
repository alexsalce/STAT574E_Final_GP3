...
### Wildfire Incidence, Coconino County

The full set of incidence data for Arizona contained 18089 total observations, 10174 of which Human caused, 5409 Naturally caused, and 2210 unknown In effort to keep our data manageable, we opted to discard unknown cause data, and filter down to Coconino County, which has the highest count of wildfire incidence in the state with 3824 incidents.
