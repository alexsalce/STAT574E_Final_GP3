...
## Research Questions (2) (Environmental data)


#### Can environmental or human factors be useful predictors in modeling resulting wildfire size?

Raymond collected our Environmental data to help address research question 2 in our models.


## Research Questions (2) (Census data)


#### Can environmental or human factors be useful predictors in modeling resulting wildfire size?

Matt collected census data to address research question 2 in our models.
...
![CIs (all but `pop.density`)](images/spglm_bin_CI1.png){#fig-ci1 width=34% fig-align="center" .lightbox}
