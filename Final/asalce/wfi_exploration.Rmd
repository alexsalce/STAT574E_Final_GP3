...
ggplot() +
  ...
  geom_sf(data = az_counties_sf, fill = "turquoise4") +
  # geom_sf(data = az_rd_primary, color="green") +
  # geom_sf(data = az_rd_secondary, color="blue") +
  # geom_sf(data = az_rd_4wd, color="blue", linewidth=0.1) +
  geom_sf(data = wfigs_az_sf[wfigs_az_sf$IncidentSize >= 1000,], size = 0.6, alpha = 0.75, color="orangered") +
